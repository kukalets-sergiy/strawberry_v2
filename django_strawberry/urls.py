...
urlpatterns = [
    ...
    path(
        f"api/{os.getenv('API_VERSION')}/<int:year>/<int:month>/", views.month_detail, name="month_detail"
    ),
    path(f"api/{os.getenv('API_VERSION')}/upload_images", views.upload_images, name="upload_images"),
    path(
        f"api/{os.getenv('API_VERSION')}/delete_file/<str:filename>/",
        views.delete_file,
        name="delete_file",
    ),
    ...
    path(f"api/{os.getenv('API_VERSION')}/choose_month/", views.choose_month, name="choose_month"),
    path(
        f"api/{os.getenv('API_VERSION')}/choose_month/<int:month_id>",
        views.choose_month,
        name="choose_month_with_id",
    ),
    path(f"api/{os.getenv('API_VERSION')}/choose_culture/", views.choose_culture, name="choose_culture"),
    path(
        f"api/{os.getenv('API_VERSION')}/choose_culture/<int:culture_id>/",
        views.api_choose_culture,
